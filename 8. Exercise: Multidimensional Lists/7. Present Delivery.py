...
while True:
    ...
    santa_row, santa_col = get_next_pos(line,santa_row,santa_col)

    if matrix[santa_row][santa_col] == "V":
        presents -= 1
        deliver_presents_good_kid += 1
    ...
    if presents == 0 or deliver_presents_good_kid == total_good_kids:
        break


if presents == 0 and deliver_presents_good_kid < total_good_kids:
    print("Santa ran out of presents!")

for row in matrix:
    print(*row, sep=" ")

if deliver_presents_good_kid == total_good_kids:
    print(f"Good job, Santa! {total_good_kids} happy nice kid/s.")
else:
    print(f"No presents for {total_good_kids - deliver_presents_good_kid} nice kid/s.")
