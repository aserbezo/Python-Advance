...
while bomb_effects and bomb_casings and not is_bombs_filled(crafted_bombs):
    # peek chislata otkolkoto da gi vzemame
...
if is_bombs_filled(crafted_bombs):
